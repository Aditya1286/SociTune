...
class RoomController {
  public async createRoom(req: Request, res: Response, next: NextFunction) {
    try {
      const hostId = (req as any).auth.userId;
      const {
        name,
        description,
        coverUrl,
  ...
  public async cancelRoom(req: Request, res: Response, next: NextFunction) {
    try {
      const userId = (req as any).auth.userId;
      const { roomId } = req.params;
  ...
  public async transferDJ(req: Request, res: Response, next: NextFunction) {
    try {
      const userId = (req as any).auth.userId;
      const { roomId } = req.params;
  ...
  public async updatePlayback(req: Request, res: Response, next: NextFunction) {
    try {
      const userId = (req as any).auth.userId;
      const { roomId } = req.params;
      ...
      if (requests !== undefined) room.requests = requests;
