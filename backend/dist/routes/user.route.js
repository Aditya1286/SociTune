...
class UserRoutes {
    path = '/api/users';
    router = Router();
    userController = Singleton.instance(UserController);
    authMiddleware = Singleton.instance(AuthMiddleware);
    constructor() {
        this.initializeRoutes();
    }
    initializeRoutes() {
        this.router.post(`${this.path}/like/:songId`, this.authMiddleware.protectRoute, asyncHandler(this.userController.toggleLikeSong));
        this.router.get(`${this.path}/liked-songs`, this.authMiddleware.protectRoute, asyncHandler(this.userController.getLikedSongs));
        this.router.get(`${this.path}/recommendations`, this.authMiddleware.protectRoute, asyncHandler(this.userController.getRecommendedUsers));
